...
<body>
    ...
    <h1>Kat & Alec's Tahoe Funding</h1>
<?php
/*==================================================================
	...
	*/
	...
	if( $ack == "SUCCESS" || $ack == "SUCESSWITHWARNING") 
	{
		...
		*/
        ...
        $confArray = confirmPayment($resArray["PAYMENTREQUEST_0_AMT"]);
        include 'mysql.php';
        write_db($firstName, $lastName, $resArray["PAYMENTREQUEST_0_AMT"], $shipToStreet, $shipToStreet2, $shipToCity, $shipToState, $shipToZip, $email, $resArray["PAYMENTREQUEST_0_CUSTOM"]);
        echo "<h3>Thank you for your kind gift and for helping make Kat and Alec's special day even better!</h3>";
        echo "<h4><a href='index.php'>Return to the main page</a> to see the difference your gift made!</h4>";
